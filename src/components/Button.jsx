...
const Button = () => {
    return ( 
        <div className="max-w-64 flex flex-col items-start gap-8 bg-black rounded-xl p-6">
            ...
            <p  className="max-w-40 text-white">We use cookies to improve your user experince</p>
            <button className=" w-full bg-white text-black p-2  rounded-lg" >I like cookies</button>
        </div>
     );
}
